...
export const metadata = {
    title: "KTET Category 2 Syllabus PDF - Upper Primary (UP)",
    description: "Download the official KTET Category 2 syllabus PDF for Upper Primary teachers. Complete syllabus covering Child Development, Malayalam, English, Mathematics, Science, and Social Studies.",
    robots: "index, follow",
    alternates: {
        canonical: "https://www.ktetpreparation.online/syllabus/category-2",
    },
};

export default function Category2SyllabusPage() {
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
                <div className="max-w-5xl mx-auto">
                    <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-center">KTET Category 2 Syllabus</h1>
                    <p className="text-center text-gray-600 mb-8">
                        Official syllabus for KTET Category II - Upper Primary (Classes VI to VIII)
                    </p>

                    {/* PDF Viewer */}
                    <div className="bg-white rounded-lg shadow-lg p-4 mb-6">
                        <iframe
                            src="/pdf/syllabus-ktet2.pdf"
                            className="w-full h-[600px] sm:h-[800px] rounded border border-gray-200"
                            title="KTET Category 2 Syllabus PDF"
                        />
                    </div>
